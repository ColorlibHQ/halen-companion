...
/**
 *
 * Halen elementor faq section section widget.
 *
 * @since 1.0
 */
class Halen_Faq_Section extends Widget_Base {

	public function get_name() {
		return 'halen-faq-section';
	}

	public function get_title() {
		return __( 'Faq Section', 'halen-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'faq_contents',
			[
				'label' => __( 'Faq content', 'halen-companion' ),
			]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default' => esc_html__( 'Frequently Ask Question', 'halen-companion' )
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Faq Items', 'halen-companion' ),
		...
		$this->add_control(
            'faq_items', [
                ...
                'fields' => [
                    [
                        'name' => 'faq_title',
                        'label' => __( 'Faq Title', 'halen-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'faq_text',
                        'label' => __( 'Faq Text', 'halen-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
     ...
     */
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Inner Styles', 'halen-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
            'item_icon_col', [
                'label' => __( 'Item Icon Color', 'halen-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'item_title_col', [
                'label' => __( 'Item Title Color', 'halen-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'item_text_col', [
                'label' => __( 'Item Text Color', 'halen-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    $info_icon = HALEN_DIR_IMGS_URI . 'info-icon.png';
    ?>
