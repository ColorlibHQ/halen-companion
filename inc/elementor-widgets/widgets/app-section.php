...
/**
 *
 * Halen elementor app section widget.
 *
 * @since 1.0
 */
class Halen_App_Section extends Widget_Base {

	public function get_name() {
		return 'halen-app-section';
	}

	public function get_title() {
		return __( 'App Section', 'halen-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'apps_content',
            [
                'label' => __( 'App Section Settings', 'halen-companion' ),
            ]
        );
        $this->add_control(
            'sec_img',
            [
                ...
                'description' => esc_html__( 'Best size is 1920x456', 'halen-companion' ),
        ...
        $this->add_control(
            'ios_url',
            [
                'label' => esc_html__( 'IOS App URL', 'halen-companion' ),
        ...
        $this->add_control(
            'android_url',
            [
                'label' => esc_html__( 'Android App URL', 'halen-companion' ),
                'type' => Controls_Manager::URL,
                'label_block' => true,
                'default'   => [
                    'url' => '#'
    ...
    $ios_app_path = HALEN_DIR_ICON_IMG_URI . 'ios-app.svg';
    $android_app_path = HALEN_DIR_ICON_IMG_URI . 'android-app.svg';
    ?>
    
    <!-- productivity_area  -->
    <div class="productivity_area" <?php echo halen_inline_bg_img( esc_url( $sec_img ) ); ?>>
        <div class="container">
