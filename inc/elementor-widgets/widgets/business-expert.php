...
/**
 *
 * Halen elementor business expert section widget.
 *
 * @since 1.0
 */
class Halen_Business_Expert extends Widget_Base {

	public function get_name() {
		return 'halen-business-expert';
	}

	public function get_title() {
		return __( 'Business Expert', 'halen-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Business Expert content', 'halen-companion' ),
			]
        );
		$this->add_control(
            'tab_content', [
                ...
                'fields' => [
                    [
                        'name' => 'tab_title',
                        'label' => __( 'Tab Title', 'halen-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Excellent Services', 'halen-companion' ),
                    ],
                    [
                        'name' => 'template_id',
                        'label' => __( 'Select Elementor Template', 'halen-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [      
                        'tab_title' => __( 'Excellent Services', 'halen-companion' ),
                    ],
                    [      
                        'tab_title' => __( 'Qualified Doctors', 'halen-companion' ),
                    ],
                    [      
                        'tab_title' => __( 'Emergency Departments', 'halen-companion' ),
                    ],
                ]
            ]
		);
    ...
    $this->start_controls_section(
        'style_room_section', [
            'label' => __( 'Style Business Expert Section', 'halen-companion' ),
            'tab' => Controls_Manager::TAB_STYLE,
        ]
    );
    $this->add_control(
        'section_head_bg_col', [
            'label' => __( 'Section Head Bg Color', 'halen-companion' ),
    ...
    $this->add_control(
        'tab_content_styles_separator', [
            'label' => __( 'Tab Content Styles', 'halen-companion' ),
    ...
    $this->add_control(
        'icon_bg_col', [
            'label' => __( 'Icon Bg Color', 'halen-companion' ),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
