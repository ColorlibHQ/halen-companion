...
/**
 *
 * Halen elementor home appointment section widget.
 *
 * @since 1.0
 */
class Halen_Home_Appointment extends Widget_Base {

	public function get_name() {
		return 'halen-home-appointment-section';
	}

	public function get_title() {
		return __( 'Home Appointment', 'halen-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Home Appointment Section', 'halen-companion' ),
            ]
        );
        $this->add_control(
            'top_img',
            [
                'label' => esc_html__( 'Top Image', 'halen-companion' ),
        ...
        $this->add_control(
            'bottom_img',
            [
                'label' => esc_html__( 'Bottom Image', 'halen-companion' ),
                'type' => Controls_Manager::MEDIA,
                'label_block' => true,
                'default'     => [
                    'url'   => Utils::get_placeholder_image_src(),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Form Contents Section', 'halen-companion' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Are You Attending?', 'halen-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Kindly respond before 30 August', 'halen-companion' ),
            ]
        );
        ...
        $this->add_control(
            'form_shortcode',
            [
                'label' => esc_html__( 'Form Shortcode', 'halen-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
            ]
        );
        ...
        $this->start_controls_section(
            'home_contact_sec_style', [
                'label' => __( 'Home Contact Section Styles', 'halen-companion' ),
        ...
        $this->add_control(
			'btn_hvr_border_bg_col', [
				'label' => __( 'Button Hover Border & Bg Color', 'halen-companion' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
    ...
    $top_img       = !empty( $settings['top_img']['id'] ) ? wp_get_attachment_image( $settings['top_img']['id'], 'halen_wedding_counter_left_img_471x280', '', array('alt' => 'home appointment top image' ) ) : '';
    $bottom_img       = !empty( $settings['bottom_img']['id'] ) ? wp_get_attachment_image( $settings['bottom_img']['id'], 'halen_attending_bottom_thumb_350x346', '', array('alt' => 'home appointment bottom image' ) ) : '';
