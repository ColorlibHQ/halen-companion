...
/**
 *
 * Halen elementor facilities section widget.
 *
 * @since 1.0
 */
class Halen_Facilities extends Widget_Base {

	public function get_name() {
		return 'halen-facilities';
	}

	public function get_title() {
		return __( 'App Facilities', 'halen-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'facilities_content',
			[
				'label' => __( 'Facilities content', 'halen-companion' ),
			]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default' => 'Save your time to <br>using halen',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Facilities', 'halen-companion' ),
