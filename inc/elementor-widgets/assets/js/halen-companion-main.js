(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".halen-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".halen-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.halen-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.halen-portfolio').isotope({
    ...
    // MC Scripts
    var $subscribe = $( '.halen-subscribe-newsletter-area' );
    if( $subscribe.length ){
