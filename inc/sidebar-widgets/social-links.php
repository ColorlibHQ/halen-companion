...
class Halen_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Halen ] Social Links', 'halen-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'halen-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'halen-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'halen-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'halen-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'halen-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'halen-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'halen-companion'); ?></label>
...
} // Class halen_social_links ends here


// Register and load the widget
function halen_social_links_widget_load() {
	register_widget( 'Halen_social_links' );
}
add_action( 'widgets_init', 'halen_social_links_widget_load' );